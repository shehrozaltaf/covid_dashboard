...
<head>
    ...
    <!-- Jquery -->
    <script src="<?php echo base_url() ?>assets/js/jquery3.2.1.js"></script>
    <!-- Custom JS -->
    <script src="<?php echo base_url() ?>assets/js/corejs.js"></script>
</head>
...
<script>
    function login() {
        ...
        if (data["Password"] != '' && data["Password"] != undefined && data["UserName"] != '' && data["UserName"] != undefined) {
            CallAjax('<?php echo base_url() . 'Login/getLogin' ?>', data, 'POST', function (Result) {
                if (Result == 1) {
                    setTimeout(function () {
    ...
    function resetPassword() {
        ...
        if (validateEmail(data['Email'])) {
            ...
            CallAjax('<?php echo base_url("Login/ForgetPass") ?>', data, "POST", function (Result) {
                if (Result == 1) {
